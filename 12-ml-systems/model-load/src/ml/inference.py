...
class Inference:
    ...
    def __load_model(self):
        ...
        bucket_name = 'xxx'
        model_key = 'xxx'
        local_model_path = os.path.join(os.path.dirname(__file__), '../weights/best_model_params.pt')
        ...
        self.model.load_state_dict(torch.load(local_model_path, map_location=self.device), strict=True)
